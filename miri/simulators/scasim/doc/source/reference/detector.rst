...
Description
~~~~~~~~~~~
The detector module contains the DetectorArray class, which
simulates the behaviour of a MIRI sensor chip assembly/detector
combination (MIRIMAGE, MIRIUFULONG or MIRIFUSHORT) with focal
plane module (FPM) 106, 104 or 105.
