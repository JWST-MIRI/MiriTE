...
----------------------
append_lrs_photom.py    - Merge imager and LRS PHOTOM CDPs into one combined CDP.
...
cdp_add_filter_band.py  - Ensures CDPs contain FILTER, CHANNEL and BAND keywords.
cdp_correct_band.py	    - Corrects the BAND keyword within MRS CDP data.
multicdp_band.csh	    - ^ Run the above script on several files.
cdp_correct_wildcard.py - Replace THING='ANY' with THING='N/A'
...
cdp_remove_junk.py	    - Remove unwanted FITS extensions and keywords from CDP data.
