...
27 Apr 2018: Temporarily replace the TypeError test with an Exception test
             while converting to Python 3.
...
#                           data=aa1, psf_lut=42)
        self.assertRaises(Exception, MiriImagingPointSpreadFunctionModel,
                          data=aa1, psf_lut=42)
